...
def make_argument_parser():
    ...
    parser.add_argument('--plm_data', '-l', type=str, required=True,help='Path to PLM data. Should be a numpy array flattend from (441,L,L), and saved as .npy format(https://numpy.org/doc/stable/reference/generated/numpy.save.html)')
...
def main():
    ...
    # load pssm
    inputs_pssm = load_pssm(pssm_data)
